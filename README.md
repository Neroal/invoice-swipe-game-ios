...
- **時間**：30 秒限時
- **計分**：`max(0, 答對 × 2 − 答錯 × 3 + 中獎加成)`
- **中獎加成**：六獎 +1、五獎 +2、四獎 +3、三獎 +4、二獎 +5、頭獎 +6、特獎 +8、特別獎 +10
...
| 獎項 | 對應位數 | 獎金 | 分數加成 | 大獎特效 |
|------|----------|------|----------|----------|
| 特別獎 | 後 8 碼完整相符 | NT$ 10,000,000 | +10 | ✓ |
| 特獎 | 後 8 碼完整相符 | NT$ 2,000,000 | +8 | ✓ |
| 頭獎 | 後 8 碼完整相符 | NT$ 200,000 | +6 | ✓ |
| 二獎 | 後 7 碼 | NT$ 40,000 | +5 | |
| 三獎 | 後 6 碼 | NT$ 10,000 | +4 | |
| 四獎 | 後 5 碼 | NT$ 4,000 | +3 | |
| 五獎 | 後 4 碼 | NT$ 1,000 | +2 | |
| 六獎 | 後 3 碼 | NT$ 200 | +1 | |
